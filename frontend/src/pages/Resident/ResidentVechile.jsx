...
const ResidentVehicleManagement = () => {
  ...
  const fetchResidentVehicles = async () => {
    try {
      setLoading(true);
      const response = await axios.get(`${API_BASE_URL}/vehicle/my-vehicles`, getAuthHeaders());
  ...
  const fetchVisitors = async () => {
    try {
      setLoading(true);
      const response = await axios.get(`${API_BASE_URL}/visitor/my-visitors`, getAuthHeaders());
  ...
  const viewVehicleLogs = async (vehicleId) => {
    try {
      ...
      const response = await axios.get(
        `${API_BASE_URL}/vehicle/logs/${vehicleId}`, 
        getAuthHeaders()
      );
  ...
  const deleteVehicle = async (vehicleId) => {
    ...
    try {
      setLoading(true);
      const response = await axios.delete(`${API_BASE_URL}/vehicle/${vehicleId}`, getAuthHeaders());
