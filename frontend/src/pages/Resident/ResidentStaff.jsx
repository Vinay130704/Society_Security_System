...
const StaffManagement = () => {
  ...
  const fetchStaff = async () => {
    ...
    try {
      const response = await axios.get(`${API_BASE_URL}/staff/resident/${residentData._id}`, getAuthHeaders());
  ...
  const addStaff = async (e) => {
    ...
    await toast.promise(
      axios.post(`${API_BASE_URL}/staff/add-staff`, payload, getAuthHeaders()).then(response => {
  ...
  const blockStaff = async () => {
    ...
    await toast.promise(
      axios.put(`${API_BASE_URL}/staff/block/${actionStaff._id}`, { remark: blockRemark }, getAuthHeaders()).then(() => {
  ...
  const unblockStaff = async (staff) => {
    await toast.promise(
      axios.put(`${API_BASE_URL}/staff/unblock/${staff._id}`, {}, getAuthHeaders()).then(() => {
        fetchStaff();
  ...
  const deleteStaff = async (staff) => {
    ...
    await toast.promise(
      axios.delete(`${API_BASE_URL}/staff/delete/${staff._id}`, getAuthHeaders()).then(() => {
        fetchStaff();
  ...
  const viewHistory = async (staff) => {
    await toast.promise(
      axios.get(`${API_BASE_URL}/staff/history/${staff.permanentId}`, getAuthHeaders()).then(response => {
  ...
  const sendMessage = async () => {
    ...
    await toast.promise(
      axios.post(`${API_BASE_URL}/staff/send-sms`, { phone: phoneNumberToSend, message: messageContent }, getAuthHeaders()).then(response => {
        if (response.data.success) {
