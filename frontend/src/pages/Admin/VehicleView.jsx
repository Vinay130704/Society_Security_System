...
const VehicleAdminPanel = () => {
    ...
    const fetchVehicles = async () => {
        try {
            ...
            const response = await axios.get("http://localhost:5000/api/vehicle/admin/all", {
                params: {
                    search: searchQuery,
    ...
    const fetchVehicleDetails = async (vehicleId) => {
        try {
            ...
            const response = await axios.get(`http://localhost:5000/api/vehicle/admin/${vehicleId}`, {
                headers: { Authorization: `Bearer ${token}` },
                timeout: 5000
            });
    ...
    const handleBlockVehicle = async () => {
        ...
        try {
            ...
            const response = await axios.post(
                `http://localhost:5000/api/vehicle/block/${selectedVehicle.vehicle_no}`,
    ...
    const handleUnblockVehicle = async (vehicleNo) => {
        ...
        try {
            ...
            const response = await axios.post(
                `http://localhost:5000/api/vehicle/unblock/${vehicleNo}`,
                {},
                {
                    headers: { Authorization: `Bearer ${token}` },
                    timeout: 5000
